...
from run_douzero import (
    app, _init_deck, _deal_cards, _cards_to_suit_format,
    _assign_card_suits, _action_to_suit_format,
    _get_legal_card_play_actions, InfoSet,
    EnvCard2RealCard, RealCard2EnvCard, Card2Suit
)
...
class TestFlaskRoutes:
    ...
    def test_save_replay_endpoint(self, client, temp_db):
        ...
        response = client.post('/save_replay',
