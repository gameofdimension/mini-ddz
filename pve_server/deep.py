...
class DeepAgent:
    ...
    def act(self, infoset):
        ...
        if player_position == 0:
            landlord_up_num_cards_left = self.get_one_hot_array(infoset.num_cards_left[2], 17)
            landlord_up_num_cards_left_batch = np.repeat(
                landlord_up_num_cards_left[np.newaxis, :], num_legal_actions, axis=0
            )

            landlord_down_num_cards_left = self.get_one_hot_array(infoset.num_cards_left[1], 17)
            ...
            landlord_num_cards_left = self.get_one_hot_array(infoset.num_cards_left[0], 20)
            ...
            if player_position == 2:
                ...
                teammate_num_cards_left = self.get_one_hot_array(infoset.num_cards_left[1], 17)
                ...
                last_teammate_action_batch = np.repeat(last_teammate_action[np.newaxis, :], num_legal_actions, axis=0)
                teammate_num_cards_left = self.get_one_hot_array(infoset.num_cards_left[2], 17)
                teammate_num_cards_left_batch = np.repeat(
                    teammate_num_cards_left[np.newaxis, :], num_legal_actions, axis=0
                )
